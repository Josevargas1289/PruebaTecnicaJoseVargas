      ...
      <header className=" w-100% p-10 mr20 bg-indigo-600 shadow-2xl shadow-slate-400  ">
        ...
        <div className=" flex">
          <p className="ml-20 mt-4 font-semibold text-indigo-50 flex-auto w-1/2">
            Este modulo genera un historico por cada tramo, que contenga el
            consumo, perdidas y costo por el consumo. Esto permite dar una
            contextualización al cliente de cómo han estado los datos en ese
            periodo de tiempo.
          </p>
          <i
            onClick={goHome}
            className="bx bxs-door-open bx-lg bx-fade-left-hover flex-1 mt-5 ml-32 text-indigo-100 cursor-pointer "
          ></i>
        </div>
      </header>
