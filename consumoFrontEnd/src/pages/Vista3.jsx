    ...
    <div className=" flex-col ">
      <header className=" w-100% p-10 mr20 bg-indigo-600 shadow-2xl shadow-slate-400  ">
        <h1 className=" uppercase ml-20  font-black text-2xl text-indigo-100  ">
          Top 20 Peores Tramos
        </h1>
        <div className=" flex">
          <p className="ml-20 mt-4 font-semibold text-indigo-50 flex-auto w-1/2">
            Este modulo genera un listado con los tramos/cliente con las mayores pérdidas. Este busca saber quién genera las mayores pérdidas y así planear un mantenimiento correctivo/preventivo, según sea el caso.
          </p>
